      ...
      <div className="h-full px-3 py-4 overflow-y-auto bg-black  dark:bg-gray-800">
        <ul className="space-y-2  font-medium">
          ...
          <li>
            ...
            >
              <svg
                className="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-black"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 18 18"
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Manage Schedule</span>
              
            </a>
          </li>
          <li>
            <a
              href="/user/manage-user-appointment"
              className="flex items-center p-2 text-white rounded-lg hover:text-black hover:bg-gray-100 dark:hover:bg-gray-700 group"
            >
              <svg
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Manage Appointments</span>
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Appointment History</span>
