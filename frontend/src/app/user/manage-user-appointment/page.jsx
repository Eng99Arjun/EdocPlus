...
const ManageAppointments = () => {
  ...
  const fetchUserAppointments = () => {
    fetch(`${process.env.NEXT_PUBLIC_API_URL}/appointment/getbypatient`, {
      headers: {
  ...
  return (
    <div className='md:w-4/5 mx-auto'>
      <h1 className='text-3xl my-10 text-center text-slate-900 font-bold'>Manage Your Appointments with Doctor</h1>
