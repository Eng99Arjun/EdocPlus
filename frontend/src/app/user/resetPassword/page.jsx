      ...
      <div> </div>
        ...
        <form action="">
            ...
            <div className='relative my-4'>
                <input type="email" className='block w-72 py-2.3 px-0  text-sm focus:outline-none bg-transparent border-0 border-b-2 border-gray-300 appearence-none dark:focus:border-blue-600 peer' placeholder=''/>
            ...
            <div className='relative my-4'>
                <input type="text" className='block w-72 py-2.3 px-0  text-sm  bg-transparent border-0  border-b-2 border-gray-300 appearance-none border:outline-none dark:focus:border-blue-600 peer 'placeholder=''/>
            ...
            <div className='relative my-4'>
                <input type="text" className='block w-72 py-2.3 px-0  text-sm  bg-transparent border-0  border-b-2 border-gray-300 appearance-none border:outline-none dark:focus:border-blue-600 peer 'placeholder=''/>
                <label htmlFor="" className='absolute text-sm  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer=focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100  peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6'> Create Password</label>
                <AiOutlineUnlock className='absolute top-4 right-4'/>
            </div>
            ...
            <button className='w-full mb-4 text-[18px] mt-6 rounded-full bg-white text-emerald-800 hover:bg-emerald-600 hover:text-white py-2 transition-colors duration-300' type="Submit">Submit</button>
